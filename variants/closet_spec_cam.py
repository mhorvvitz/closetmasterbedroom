...
T_TRIM = 10            # applied shaker frame trim on the drawer fronts
...
rev = "C — deck 1 at 1900, open entry on L-brackets"
style = "frameless_kd"
...
_CAM, _DOW, _SCR = "cam_and_dowel", "glued_dowel", "confirmat"
joint_overrides = {}
for tag in ("L", "R"):
